...
## fix grib attributes
[ -s ens/ec-${bsf}_$year${month}_swvls-24h-$abr-50.grib ] && [ ! -s ens/ec-${bsf}_$year${month}_swvls-24h-$abr-50-fixed.grib ] && \
...
[ -s ens/ec-${bsf}_$year${month}_stl-24h-$abr-50.grib ] && [ ! -s ens/ec-${bsf}_$year${month}_stl-24h-$abr-50-fixed.grib ] && \
...
[ -s ens/ec-${bsf}_$year${month}_swvls-24h-$abr-50-fixed.grib ] && [ ! -s grib/EC${bsf}_$year${month}01T000000_swvls-24h-$abr.grib ] &&\
...
[ -s ens/ec-${bsf}_$year${month}_stl-24h-$abr-50-fixed.grib ] && [ ! -s grib/EC${bsf}_$year${month}01T000000_stl-24h-$abr.grib ] &&\
