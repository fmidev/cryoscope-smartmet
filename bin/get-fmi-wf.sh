...
conda activate xr
grib_copy fmi-smartmet-$date-*.grib grib/SMARTMET_20000101T000000_${date}T000000_[shortName].grib
#mv fmi-smartmet-$ydate-swvl2-cum.grib grib/SMARTOBS_20000101T000000_${date}T090000_swvl2.grib
#rm grib/SMARTOBS_20000101T000000_${ydate}T090000_swvl2.grib
#grib_copy fmi-smartmet-$ydate-synop-krg.grib grib/SMARTOBS_20000101T000000_${ydate}T000000_[shortName].grib
grib_copy fmi-smartmet-$ydate-*-krg.grib grib/SMARTOBS_20000101T000000_${ydate}T000000_[shortName].grib
rm grib/SMARTOBS_20000101T000000_${ydate}T000000_sd.grib
...
if [ -s "grib/SMARTMET_20000101T000000_${date}T000000_sfara.grib" ] 
then 
    cdo --eccodes -O chparam,144.173.192,11.1.0 -mulc,0.001 -add grib/SMARTMET_20000101T000000_${edate}T000000_sfara.grib \
    -remapbil,smartmet-sk-grid -selname,sd -seltimestep,1 grib/ERA5_20000101T000000_${edate}T000000_base+soil.grib sde-state.grib
    cdo --eccodes chparam,144.173.192,11.1.0 -add -mulc,0.001 grib/SMARTMET_20000101T000000_${date}T000000_sfara.grib \
    -seltimestep,8 sde-state.grib grib/SMARTMET_20000101T000000_${date}T000000_sde.grib
else
...
then 
    #cdo --eccodes chparam,141.228,141.128 -mulc,0.01 fmi-smartmet-$ydate-sd-krg.grib grib/SMARTOBS_20000101T000000_${date}T000000_sde.grib
    cdo --eccodes chparam,141.228,66.3 -mulc,0.01 fmi-smartmet-$ydate-sd-krg.grib grib/SMARTOBS_20000101T000000_${date}T000000_sde.grib
else
