...
then
    ...
    cdo -f grb2 -b P15 copy -setunit,C -settime,12:00:00 -setdate,$ymd -setparam,17.0.0 -setgrid,amsr-g-grid -mulc,0.01 -setrtomiss,-32768,-32760 amsr/GW1AM2_${ymd}_01D_EQOA_L3RGLSTHU1100100.nc grib/AMSR_20000101T120000_${ymd}_01D_EQOA_L3RGLSTHU1100100.grib &&\
...
then
    ...
    cdo -f grb2 -b P15 copy -setunit,C -settime,00:00:00 -setdate,$ymd -setparam,17.0.0 -setgrid,amsr-g-grid -mulc,0.01 -setrtomiss,-32768,-32760 amsr/GW1AM2_${ymd}_01D_EQOD_L3RGLSTHU1100100.nc grib/AMSR_20000101T000000_${ymd}_01D_EQOD_L3RGLSTHU1100100.grib&&\
