...
#date='20240101T000000Z-20240803T000000Z'
#date='20190101T000000Z-20190804T000000Z'
date='20190601T000000Z-20200102T000000Z'
yearmon=date[0:6]
data_dir='/home/ubuntu/data/OCEANIDS/'
f1 = 'obs-oceanids-'+date+'-all-daymean-daymax.csv' # observations 
f2 = 'ECXSF_'+yearmon+'_WG_PT1H_MAX_Vuosaari_151028.csv' # sf XGBoost prediction
cols1=['utctime','WG_PT1H_MAX']
...
#print(df_xgb)
# threshold for obs wind speed>= k, % of ensemble members above k
k=15
df_max=df_xgb[df_xgb.WG_PT1H_MAX>=k]
#print(df_max)
...
mytitle='ECXSF WG_PT1H_MAX Vuosaari 151028 '+yearmon 
...
plt.ylim(0,30)
fig.savefig(data_dir+'ECXSF_WG_PT1H_MAX_Vuosaari_151028_'+yearmon+'.png',dpi=500)
...
# plot crps
mytitle='CRPS WG_PT1H_MAX Vuosaari 151028 '+yearmon
plot = df_crps.plot(figsize=(15,10), title=mytitle,linewidth=0.2)
fig = plot.get_figure()
plt.legend(bbox_to_anchor=(1.0, 1.0))
fig.savefig(data_dir+'CRPS_WG_PT1H_MAX_Vuosaari_151028_'+yearmon+'.png',dpi=500)

# plot ecsf with average threshold exceedance
mytitle='ECSF WG_PT1H_MAX Vuosaari 151028 '+yearmon
...
plt.ylim(0,30)
plt.legend(bbox_to_anchor=(1.0, 1.0))
fig.savefig(data_dir+'ECSF_WG_PT1H_MAX_Vuosaari_151028_'+yearmon+'.png',dpi=500)
